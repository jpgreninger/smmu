...
- [command-queue.md](command-queue.md) — must be initialized and enabled before issuing invalidation commands
- [event-queue.md](event-queue.md) — must be initialized before enabling translation
