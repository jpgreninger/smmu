...
| Memory attributes | Memory type, Shareability, Cacheability, and allocation hints from the upstream device. All are optional and can be overridden per STE configuration. See [[concepts/attribute-transformation]]. |
...
See [[concepts/coherency-and-embedded-implementations]] for the full coherency model including COHACC, HTTU atomicity rules, and client-side coherency behavior.
...
See [[concepts/pcie-ats-pri]] for the SMMU-side ATS and PRI semantics.
...
See [[synthesis/smmu-system-implementation]] §16.7.4 for the full downstream abort event table.

---

## Related Concepts

- [[concepts/streamid-substreamid]] — StreamID and SubstreamID semantics; SEC_SID interaction with Stream table selection
- [[concepts/security-states]] — SEC_SID encoding (NS/Secure/Realm/Root); which programming interface controls a stream
- [[concepts/pcie-ats-pri]] — AT field handling; Translation Request/Translated/Untranslated transaction types; ATS interface semantics
- [[concepts/coherency-and-embedded-implementations]] — COHACC flag; HTTU atomicity and coherency port requirements; client coherency model
- [[concepts/attribute-transformation]] — input memory attribute override rules (Chapter 13)
- [[concepts/httu]] — HTTU atomic update mechanism and its port coherency dependency
- [[synthesis/smmu-system-implementation]] — system integration requirements including downstream abort handling (§16.4, §16.7)

## Sources That Use This Concept

- [[sources/ihi0070g-b-smmuv3-architecture-spec]] — §14.1 Data path ingress/egress ports; §14.2 ATS Interface; §14.3 SMMU-originated transactions; §3.10.1 SEC_SID; §3.13 HTTU coherency requirements
