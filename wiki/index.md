...
| [concepts/stream-table-entry.md](concepts/stream-table-entry.md)        | Per-stream configuration structure (STE); §5.1 L1STD format (Span/L2Ptr); §5.2.2 SteIllegal() pseudocode; Config encoding, stage 2 fields |
| [concepts/context-descriptor.md](concepts/context-descriptor.md)        | Stage 1 translation configuration (CD); §5.3 L1CD format; §5.4.1 EL2/EL3 SubstreamID restrictions, multi-STE sharing rules, TLB-cacheable field list; TTB0/TTB1, ASID, fault flags, validity conditions |
...
| [concepts/pcie-ats-pri.md](concepts/pcie-ats-pri.md)              | PCIe ATS/PRI — §3.9.1.1–3.9.1.5 full Translated/TR handling tables, event priority list, PASIDTT/EATS PnU/InD, CERROR_ATC_INV_SYNC timeout, UR behavior; STE.EATS, ATC invalidation, CXL; §3.9.4 T/TE/XT bit handling |
...
| [concepts/atos.md](concepts/atos.md)                      | Address Translation Operations — ATOS/VATOS facility; §9.1.4 ATOS_PAR encoding (REASON/FADDR table); §9.1.5 FAULTCODE table; GPC interaction |
| [concepts/command-formats.md](concepts/command-formats.md)           | Chapter 4 command encoding reference: opcode table, common fields (SSec/SSV), all CFGI/TLBI/ATS/DPTI/SYNC/RESUME command encodings and guarantees |
...
| [concepts/attribute-transformation.md](concepts/attribute-transformation.md)  | Attribute transformation — §13.5 full output attribute determination table (7 attrs × 5 configs); MT/SH/RA/WA/TR/INST/PRIV/NS combination/override; §13.6 PCIe/ATS attributes; §13.7 ATS permission interpretation |
