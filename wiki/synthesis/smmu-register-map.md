...
- `SMMU_ROOT_GPT_BASE{,_CFG}`, `SMMU_ROOT_GPT_BASE2`: Granule Protection Table base address and configuration (see [[concepts/granule-protection-check]]).
...
- [[concepts/smmu-initialization]] — CR0/CR0ACK handshake and initialization sequence
- [[concepts/command-queue]] — CMDQ_BASE, PROD, CONS register usage
- [[concepts/event-queue]] — EVENTQ register usage; Page 1 PROD/CONS
- [[concepts/pcie-ats-pri]] — PRIQ register usage; GATOS for ATS debugging
- [[concepts/security-states]] — Secure register block (0x8000), Root Control Page, Realm Pages
- [[concepts/granule-protection-check]] — Root Control Page GPT registers
- [[concepts/atos]] — GATOS/VATOS register groups
- [[concepts/mpam]] — MPAMIDR, GMPAM, GBPMPAM registers
- [[concepts/mec]] — SMMU_R_MECIDR, SMMU_R_GMECID
- [[synthesis/smmu-version-feature-map]] — IDR0/IDR3 feature bits by version
