...
- If AT == Translated and `ATSCHK == 1`: apply Translated transaction checks (see [[concepts/pcie-ats-pri]]).
...
- **Is configurable** (Translation-related faults during translation walks at either stage): behavior determined by CD.{S,R,A} for stage 1 and STE.{S2S,S2R} for stage 2. See [[concepts/fault-models]].
...
| Figure 15.4 | ATS Translation Request handling | Step 3 + [[concepts/pcie-ats-pri]] §3.9 |
| Figure 15.5 | Translated transaction (ATSCHK) handling | [[concepts/pcie-ats-pri]] §ATSCHK |
| Figure 15.6 | SMMU-originated transaction flow | [[concepts/external-interfaces]] §14.3 |
...
- [[concepts/two-stage-translation]] — complete address size and translation semantics
- [[concepts/stream-table-entry]] — STE structure and Config encoding
- [[concepts/context-descriptor]] — CD structure and stage 1 parameters
- [[concepts/fault-models]] — fault behavior at each translation step
- [[concepts/tlb-invalidation]] — cache maintenance
- [[concepts/security-states]] — SEC_SID governs which tables/queues are used
- [[concepts/granule-protection-check]] — Step 10 detail
- [[concepts/pcie-ats-pri]] — AT field handling, ATS response semantics (§3.9.1.2), ATSCHK
- [[concepts/external-interfaces]] — SMMU-originated transactions (§14.3); Chapter 14 ingress/egress port
- [[synthesis/smmu-fault-model]] — detailed fault model subsystem reference
- [[synthesis/smmu-security-states]] — security state pipeline variations
