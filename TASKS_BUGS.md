...
| Section | Title | C++ | Rust | Bugs | Notes |
|---------|-------|-----|------|------|-------|
| §3.10 | Security States (NS support, NS→NS PA) | N/A | ✅ | | Re-audited 2026-05-02: SMMU always supports NS (PASS); NS stream→NS PA enforcement via address_space security check (PASS, test_bug_audit140_sec_sid_spec.rs); doc clarification on to_bits/from_bits vs SEC_SID input |
| §3.10.1 | StreamID Security state (SEC_SID) | N/A | ✅ | | Re-audited 2026-05-02: SEC_SID 2-bit encoding 0b00/0b01/0b10 PASS; SECURE_IMPL==0 default NonSecure PASS; 0b11=Reserved vs Root clarified in doc (no behavioral gap — no external SEC_SID decode boundary). 10 spec-anchored tests added. |
