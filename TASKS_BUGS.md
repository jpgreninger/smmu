...
| Section | Title | C++ | Rust | Bugs | Notes |
|---------|-------|-----|------|------|-------|
| §3.18 | Interrupts and notifications | ✅ | ✅ | BUG-AUDIT-147 ✅ | GERROR/GERRORN toggle protocol correct; MSI/wired simulated (no real HW writes); interrupt notification ordering satisfied structurally. C++ verified 2026-04-12; TDD: `P3IrqCtrl.IrqCtrlAckMirrorsWrite`. Re-audited 2026-05-04: 11 items checked (4 PASS, 4 N/A, 3 N/A MSI), 1 bug fixed (BUG-AUDIT-147). |
