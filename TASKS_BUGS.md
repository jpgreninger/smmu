...
| §3.10.1 | StreamID Security state (SEC_SID) | ⚠️ | ✅ | BUG-AUDIT-159-CPP | Re-audited 2026-05-08 (C++): SEC_SID 2-bit encoding PASS (types.h:508-517); SECURE_IMPL==0 default NS PASS; SECURE_IMPL==1 separate stream tables MISSING — single streamMap only (BUG-AUDIT-159-CPP). |
