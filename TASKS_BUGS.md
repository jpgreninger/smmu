...
| §3.10.2 | Support for Secure state | ⚠️ | 🚫 | BUG-AUDIT-159-CPP, BUG-AUDIT-160-CPP | Re-audited 2026-05-08 (C++): SSec param PASS (CommandEntry::ssec); RAZ/WI register access N/A (no MMIO); PA routing N/A; Secure queue/table MISSING (BUG-AUDIT-159-CPP); SIF flag MISSING (BUG-AUDIT-160-CPP); S2AA64 check PASS smmu.cpp:1185; VMID tagging PASS smmu.cpp:764-771. |
| §3.10.2.1 | Secure commands, events, configuration | ⚠️ | 🚫 | BUG-AUDIT-159-CPP, BUG-AUDIT-160-CPP | Re-audited 2026-05-08 (C++): NS cmd→NS streams only PASS (SSec=1 CERROR_ILL); event routing by securityState MISSING (BUG-AUDIT-159-CPP); SIF behavior MISSING (BUG-AUDIT-160-CPP). |
