...
| Section | Title | C++ | Rust | Bugs | Notes |
|---------|-------|-----|------|------|-------|
| §3.9.1 | ATS Interface | ⚠️ | ⚠️ | AUDIT-01, NEW-FINDING-1, BUG-AUDIT-125, BUG-AUDIT-128 | Re-audited 2026-05-01: IDR0.ATS=1 ✓, IDR0.PRI configurable ✓, SMMUEN=0→F_BAD_ATS_TREQ ✓, ATSCHK+EATS=0→F_TRANSL_FORBIDDEN ✓. BUG-AUDIT-128 NEW: effective EATS=0b00 rule not enforced when ATSCHK=0 for EATS=0b10 streams — ATS TR incorrectly accepted; fixed by computing effective_eats before ats_supported check (`mod.rs:4439`). Secure-conditional items N/A (SecP=0). HTTU+ATS flag update PASS via addr_space.update_access_flags path. |
| §3.9.1.1 | Handling of addresses in ATS-related transactions | ⚠️ | ⚠️ | | Re-audited 2026-05-01: IMPL DEF per spec — truncate or abort on PA overflow, both permitted. No behavioral gap. |
| §3.9.1.2 | Responses to ATS Translation Requests | ⚠️ | ⚠️ | BUG-AUDIT-126, BUG-AUDIT-128 | Re-audited 2026-05-01: SMMUEN=0→F_BAD_ATS_TREQ ✓, Config=0b000→silent UR ✓, Config=0b100→F_BAD_ATS_TREQ ✓, EATS=0→F_BAD_ATS_TREQ ✓. BUG-AUDIT-128 fixed: effective EATS=0b00 for EATS=0b10+ATSCHK=0 now correctly rejects ATS TR with F_BAD_ATS_TREQ. ATS TR fault suppression (no event for F_TRANSLATION/F_ADDR_SIZE/F_ACCESS/F_PERMISSION) ✓. RnW=UNKNOWN acceptable ✓. Secure items N/A. |
| §3.9.1.3 | Handling of ATS Translated transactions | ⚠️ | ⚠️ | BUG-AUDIT-125, BUG-AUDIT-127 | Re-audited 2026-05-01: SMMUEN=0→F_TRANSL_FORBIDDEN ✓, Config=0b000+ATSCHK=1→silent abort ✓, Config=0b100+ATSCHK=1→F_TRANSL_FORBIDDEN ✓, EATS=0+ATSCHK=1→F_TRANSL_FORBIDDEN ✓, SSV=1 fault recording ✓, event priority preserved structurally ✓. PASIDTT/Realm items N/A. Secure items N/A. |
| §3.9.1.4 | ATS Invalidation timeout | ⚠️ | ⚠️ | AUDIT-81 | Re-audited 2026-05-01: CERROR_ATC_INV_SYNC defined but never triggered (AUDIT-81 still open). Software model processes CMD_ATC_INV synchronously — no real endpoint timeout possible. Acceptable gap for software simulation. |
