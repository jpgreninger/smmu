...
| §3.5.3 | Event queue behavior | ⚠️ | ✅ | AUDIT-75 | Re-audited 2026-04-30: EVENTQEN gate enforced at all enqueue_event call sites ✓; stall events buffered in stall_pending on full queue ✓; non-stall events discarded + OVFLG toggled ✓; stall drain on next write/read ✓; CMD_SYNC enforces visibility via Release-ordered synchronous model ✓. No new defects. |
