...
| §3.10.3 | Support for Realm state | ⚠️ | 🚫 | BUG-AUDIT-161-CPP, BUG-AUDIT-162-CPP | Re-audited 2026-05-08 (C++): VMSAv8-64 N/A (AArch64 global); table format N/A (abstract model); CD.NSCFG ignored for Realm MISSING (BUG-AUDIT-161-CPP); Realm SSec=1 CERROR_ILL MISSING (BUG-AUDIT-162-CPP). |
| §3.10.3.1 | Input NS attribute (Realm default) | ⚠️ | 🚫 | BUG-AUDIT-162-CPP | Re-audited 2026-05-08 (C++): Realm stream default NS attribute → Realm MISSING; determineContextSecurityState() returns NonSecure for unconfigured streams smmu.cpp:6425 (BUG-AUDIT-162-CPP). |
| §3.10.3.2 | Realm stream disabled | ✅ | 🚫 | | Re-audited 2026-05-08 (C++): Config==0b000 → F_STREAM_DISABLED → abort PASS smmu.cpp:715-718,1099. |
| §3.10.3.3 | Realm stream bypass | ⚠️ | 🚫 | BUG-AUDIT-163-CPP | Re-audited 2026-05-08 (C++): bypass fault types PASS (F_ADDR_SIZE, F_BAD_ATS_TREQ, F_TRANSL_FORBIDDEN); NSCFG output PA derivation MISSING — nsCfgOut written but never consumed smmu.cpp:1955 (BUG-AUDIT-163-CPP); MECID N/A. |
